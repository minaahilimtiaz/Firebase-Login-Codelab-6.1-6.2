...
class MainFragment : Fragment() {
        ...
        viewModel.authenticationState.observe(viewLifecycleOwner, Observer { authenticationState ->
            when (authenticationState) {
                LoginViewModel.AuthenticationState.AUTHENTICATED -> {
                    updateUIForAuthenticatedUsers(factToDisplay)
                }
                else -> {
                    updateUIForUnAuthenticatedUsers(factToDisplay)
                }
            }
        })
    }

    private fun updateUIForUnAuthenticatedUsers(factToDisplay: String) {
    ...
    private fun updateUIForAuthenticatedUsers(factToDisplay: String) {
